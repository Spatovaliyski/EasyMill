-- Credit to Auctionator for the mill table. This is just reusing it locally to avoid unecessary/unsupported API Calls
...
local MILL_ITEMS = {
	...
	-- Mists herbs
	GREEN_TEA_LEAF = "72234",
	SILKWEED = "72235",
	RAIN_POPPY = "72237",
	SNOW_LILY = "79010",
	DESECRATED_HERB = "89639",
	FOOLS_CAP = "79011",
...
MillTable = {
	...
	-- Mists
	[MILL_ITEMS.RAIN_POPPY] = {
		[MILL_ITEMS.SHADOW_PIGMENT] = { 0, 0.5, 0.5, 0.0001 },
		[MILL_ITEMS.MISTY_PIGMENT] = { 0.25, 0.005, 0.005 },
	},
	[MILL_ITEMS.GREEN_TEA_LEAF] = {
		[MILL_ITEMS.SHADOW_PIGMENT] = { 0, 0.5, 0.5, 0.0001 },
		[MILL_ITEMS.MISTY_PIGMENT] = { 0.25, 0.005, 0.005 },
	},
	[MILL_ITEMS.SILKWEED] = {
	...
	[MILL_ITEMS.SNOW_LILY] = {
		[MILL_ITEMS.SHADOW_PIGMENT] = { 0, 0.5, 0.5, 0.0001 },
		[MILL_ITEMS.MISTY_PIGMENT] = { 0.25, 0.005, 0.005 },
	},
	[MILL_ITEMS.DESECRATED_HERB] = {
		[MILL_ITEMS.SHADOW_PIGMENT] = { 0, 0.5, 0.5, 0.0001 },
		[MILL_ITEMS.MISTY_PIGMENT] = { 0.25, 0.005, 0.005 },
	},
	[MILL_ITEMS.FOOLS_CAP] = {
		[MILL_ITEMS.SHADOW_PIGMENT] = { 0, 0.6, 0.6, 0.001 },
		[MILL_ITEMS.MISTY_PIGMENT] = { 0.5, 0.01, 0.01 },
	},
}
