...
EasyMill.millableItemIDs = {
    -- Vanilla
    2447, 765, 785, 2450, 2452, 2453, 3355, 3356, 3357, 3358,
    3369, 3818, 3820, 3821, 4625, 8831, 8836, 8838, 8839,
    8845, 8846, 13463, 13464, 13465, 13466, 13467,
    -- TBC
    22785, 22786, 22787, 22789, 22790, 22791, 22792, 22793,
    -- Wrath
    36901, 36903, 36904, 36905, 36906, 36907, 37921,
    -- Cata
...
function EasyMill:getProfit(itemID)
    ...
    if not entry or not entry.link then return nil end
